        ...
        <div class="main-panel" slot="body">
                    ...
                    <div class="table-responsive">
                      <table class="table">
                        ...
                        <tbody>
                          <tr>
                            <td>
                              <img src="../../assets/images/nihu-logo1.svg" class="mr-2" alt="image"> David Grey </td>
                          ...
                          <tr>
                            <td>
                              <img src="../../assets/images/nihu-logo1.svg" class="mr-2" alt="image"> Stella Johnson </td>
                          ...
                          <tr>
                            <td>
                              <img src="../../assets/images/nihu-logo1.svg" class="mr-2" alt="image"> Marina Michel </td>
                          ...
                          <tr>
                            <td>
                              <img src="../../assets/images/nihu-logo1.svg" class="mr-2" alt="image"> John Doe </td>
            ...
            <footer class="footer">
                <div class="d-sm-flex justify-content-center justify-content-sm-between">
                        <span class="text-muted text-center text-sm-left d-block d-sm-inline-block">Copyright © 2019 Nihu. All rights reserved.</span>
